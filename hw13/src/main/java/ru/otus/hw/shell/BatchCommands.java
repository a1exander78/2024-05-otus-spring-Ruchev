...
import static ru.otus.hw.config.JobConfig.IMPORT_USER_JOB_NAME;
import static ru.otus.hw.config.JobConfig.INPUT_FILE_NAME;
import static ru.otus.hw.config.JobConfig.OUTPUT_FILE_NAME;
