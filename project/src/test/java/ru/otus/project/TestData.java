...
public abstract class TestData {
    ...
    protected static final User SASHA = new User(ID_2, "1_1", "$2a$12$TTmL9DtXP5EvS/6f9Omm4eRUShdv4bYYw6fk3qhJGj0kWsf.FKXEq", "sasha", LENINA_1_1, List.of(new Authority(ID_2, "ROLE_USER")));
    ...
    protected static final UserDto USER_MISHA = new UserDto(ID_4, "2_11", "$2a$12$G118Fg7mO3x7zCZr0U6SNOWb4PlE9divBRmqmSzI2a0JfDrnDQZWW", "misha", PUSHKINA_2_11, List.of(AUTHORITY_USER));
    protected static final UserDto USER_MASHA = new UserDto(ID_5, "2_22", "$2a$12$.LLkfMuREU1baRDgMRQJw.WO6Z0uNZc4AuOYvoxhMkw3zJc1xETFq", "masha", PUSHKINA_2_22, List.of(AUTHORITY_USER));
